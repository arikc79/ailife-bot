...
TOOL_CAPABILITIES = {
    ...
    "nanobanana": "NanoBanana (@nanobanana_gidbot): AI-генерація зображень і редагування фото прямо в Telegram — без додатків; текст або голос → картинка за 3 секунди; унікальні режими: відновлення старих фото, студійний аватар із селфі, спільне фото з зіркою, перенос в будь-яку епоху або фільм, відео-режим",
}
